...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        if ("before".equals(route.getAction()) || "after".equals(route.getAction())) {
            throw new NotFoundException();
        }
        Method method = getMethodByName(pageClass, route.getAction());
        Method beforeMethod = getMethodByName(pageClass, "before");
        Method afterMethod = getMethodByName(pageClass, "after");
        ...
        runMethod(request, page, view, pageClass, beforeMethod);
...
//                System.out.println(validationException.getMessage());
        ...
        runMethod(request, page, view, pageClass, afterMethod);
    ...
    private Method getMethodByName(Class<?> pageClass, String methodName) throws NotFoundException {
        Method method = null;
    ...
    private void runMethod(HttpServletRequest request,
                           Object page, Map<String, Object> view, Class<?> pageClass,
